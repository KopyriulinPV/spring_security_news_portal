...
@Component
@Slf4j
public class VerificationDeleteNewsModerator {
    ...
    @Around("@annotation(DeleteNewsVerification)")
    public Object logAround(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        News news = newsRepository.findById(Long.parseLong(pathVariables.get("Id").toString())).get();
