...
@Component
@Slf4j
public class VerificationAdminUserModerator {
    ...
    @Around("@annotation(AdminUserModeratorVerification)")
    public Object logAround(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        News news = newsRepository.findById(Long.parseLong(pathVariables.get("newsId").toString())).get();
        User theRrequestUser = userRepository.findById(news.getAuthor().getId()).get();
